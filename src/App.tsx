  ...
  useEffect(() => {
    ...
    const detect = async () => {
      try {
        ...
        if (!stopped) setPaymentStatus("Pagamento pendente. A posição será atualizada após a confirmação.");
      }
    };
    void detect();
